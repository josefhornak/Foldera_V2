...
/** Record one processed document toward usage (monthly counter + trial counter). */
export async function recordDocumentUsage(company: Pick<Company, 'id' | 'billingStatus'>): Promise<void> {
